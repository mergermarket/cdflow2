...
MML799:cdflow2 marciog$ gofmt -s config/container_test.go > config/container_test.go 
config/container_test.go:1:1: expected 'package', found 'EOF'
MML799:cdflow2 marciog$ gofmt -s config/container_test.go
package config_test
